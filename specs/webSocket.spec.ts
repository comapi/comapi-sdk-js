...
describe("webSocket Manager tests", () => {
    ...
    describe("enabling webSocket tests", () => {
         ...
         * 
         */
        it("should fail to connect when sockets disabled (default)", done => {
         ...
         * 
         */
        it("should enable websocket and connect then disconnect", done => {

            webSocketManager.setWebsocketEnabled(true)
                .then(() => {
                    let isConnected = webSocketManager.isConnected();
                    console.log("isConnected = " + isConnected);
         ...
         * 
         */
        it("should disable websocket and disconnect", done => {
            ...
            webSocketManager.setWebsocketEnabled(true)
                ...
                .then(() => {
                    ...
                    console.log("isConnected = " + isConnected);
                    expect(isConnected).toBeTruthy();
                    return webSocketManager.setWebsocketEnabled(false);
                })
                .then(() => {
                    let isConnected = webSocketManager.isConnected();
                    console.log("isConnected = " + isConnected);
         ...
         * 
         */
        it("should not schedule timeout to reconnect when sockets are disabled (default)", () => {
    ...
    describe("webSocket enabled tests", () => {
